    ...
    <section id="hero" className="relative min-h-[80vh] flex items-center justify-center pt-20 bg-background">
      <div className="container relative z-10 px-6 md:px-8">
        <div className="max-w-6xl mx-auto">
          {/* Main Headline */}
          <h1 className="font-heading text-5xl md:text-7xl font-bold mb-12 leading-[0.9] tracking-tighter text-foreground">
            Apps. <br />
            <span className="text-primary">Websites.</span> <br />
            Automations.
          </h1>

          <p className="text-xl text-balance md:text-2xl text-foreground/70 font-light max-w-2xl mb-12">
            We are tech consultants building software products. <br/>
